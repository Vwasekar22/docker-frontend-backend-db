...
insert into country_and_capitals(country, capital) values ('Australia', 'Canberra');
insert into country_and_capitals(country, capital) values ('New Zealand', 'Wellington');
insert into country_and_capitals(country, capital) values ('Japan', 'Tokyo');
